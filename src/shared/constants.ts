// Centralized product identity + tuning constants (name/version in one place).
...
/** URL schemes on which a page cannot be scripted, so only visible-area capture may work. */
